...
class start extends system
{
	...
	{
		$return = '';
		$RS = database::Query('SELECT * FROM files WHERE user_id=:var1', array("var1"=>$user_id));
	...
	{	
		...
		foreach($RS as $msg)
		{
			...
			{
				//RELO MSG
				$return .= '<div class="row chat_entry chat_relo" data-chatid="' . $msg['id'] . '">
		                        ...
		                        <div class="col-xs-1">
		                        	<img class="chat_userimg" src="data/img/testuser.jpg">
		                        </div>
		                    </div>';
			}
			...
			{
				$return .= '<div class="row chat_entry chat_client" data-chatid="' . $msg['id'] . '">
		                        <div class="col-xs-1">
		                        	<img class="chat_userimg" src="data/img/testuser.jpg">
		                        </div>
