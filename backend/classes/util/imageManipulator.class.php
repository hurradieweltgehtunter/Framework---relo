...
class ImageManipulator
{
     ...
     * @param  boolean $constrainProportions Constrain current image proportions when resizing
     * @return ImageManipulator for a fluent interface
     * @throws RuntimeException
     */
     ...
     * @param  integer $xpos   X-Position of image in new canvas, null for centre
     * @param  integer $ypos   Y-Position of image in new canvas, null for centre
     * @return ImageManipulator for a fluent interface
     * @throws RuntimeException
     */
     ...
     * Crop image
     *
     * @param  integer $x1 Top left x-coordinate of crop box or array of coordinates
     * @param  integer $y1 Top left y-coordinate of crop box
     * @param  integer $x2 Bottom right x-coordinate of crop box
     * @param  integer $y2 Bottom right y-coordinate of crop box
     * @return ImageManipulator for a fluent interface
     * @throws RuntimeException
     */
